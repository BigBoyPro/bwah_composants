...
class MeasurementSystemManager private constructor() {

    companion object {
        private const val SETTINGS_PREFS = "settings"
        private const val MEASUREMENT_SYSTEM_KEY = "measurement_system"
        private const val WEIGHT_SYSTEM_KEY = "weight_system"
        private const val METRIC_UNITS_KEY = "metric_units"
        private const val IMPERIAL_UNITS_KEY = "imperial_units"
        private const val KILOGRAM_UNITS_KEY = "kilogram_units"
        private const val POUND_UNITS_KEY = "pound_units"
